    ...
    def process_item(self, data_item):
        ...
        if not drop_ref_img and 'input_images' in data_item and data_item['input_images'] is not None:
            ...
            for input_image_path in input_images_path:
                ...
                input_image = self.image_processor.preprocess(input_image, max_pixels=self.max_pixels, max_side_length=self.max_side_length)
        ...
        output_image = self.image_processor.preprocess(output_image, max_pixels=self.max_pixels, max_side_length=self.max_side_length)
