        ...
        do
            ...
            do
                ...
                do
                    ...
                    --negative_prompt "" \
                    --align_res \
                    --result_dir experiments/${experiment_name}/results_${step[m]}_gs6.0_ref_gs${ref_guidance_scale[j]}_shift${shift[k]}_apply_chat_template_negative_prompt_${negative_prompt_chat_template_version[l]}_neg_prompt_null_align_res
                done
            done
        done
    done
