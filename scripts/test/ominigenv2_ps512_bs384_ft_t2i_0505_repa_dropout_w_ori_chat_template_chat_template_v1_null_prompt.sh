...
experiments=(
ominigenv2_ps512_bs384_ft_t2i_0505_repa_dropout_w_ori_chat_template
)
...
do
    ...
    do
        ...
        do
            ...
            --negative_prompt_chat_template_version v1 \
            --negative_prompt "" \
            --result_dir experiments/${experiments[i]}/results_${step}_gs${guidance_scale[j]}_shift${shift[k]}_apply_chat_template_negative_prompt_v1_null_neg_prompt
        done
    done
done