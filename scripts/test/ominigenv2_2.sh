...
experiments=(
ominigenv2_ps256_bs2048_ft_mixed_data_0425_disable_fused_rmsnorm
)
...
do
    ...
    do
        ...
        do
            ...
            --dynamic_size \
            --result_dir experiments/${experiments[i]}/results_${step}_ps384_gs${guidance_scale[j]}_shift${shift[k]}
        done
    done
done