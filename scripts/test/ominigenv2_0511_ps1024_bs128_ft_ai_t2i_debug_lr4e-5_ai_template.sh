...
experiment_name=ominigenv2_0511_ps1024_bs128_ft_ai_t2i_debug_lr4e-5
        ...
        do
            ...
            do
                ...
                do
                    ...
                    --negative_prompt "" \
                    --result_dir experiments/${experiment_name}/results_${step[m]}_gs${guidance_scale[j]}_shift${shift[k]}_ai_template_apply_chat_template_negative_prompt_${negative_prompt_chat_template_version[l]}_neg_prompt_null
                done
            done
        done
    done
