...
experiment_name=ominigenv2_0519_ps512_bs192_ft_edit_icedit_lr4e-5
...
# data_options/test_aigc_edit_background_change.yml
# data_options/test_edit_subject_replacement.yml
)
        ...
        do
            ...
            do
                ...
                do
                    ...
                    --negative_prompt "" \
                    --result_dir experiments/${experiment_name}/results_${step[m]}_gs${guidance_scale[j]}_shift${shift[k]}_apply_chat_template_negative_prompt_${negative_prompt_chat_template_version[l]}_neg_prompt_null
                done
            done
        done
    done
